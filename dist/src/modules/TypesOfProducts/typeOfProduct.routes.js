...
class TypeOfProductRouter {
    ...
    initializeRoutes() {
        ...
        this.typesOfProductController.createTypeOfProduct.bind(this.typesOfProductController));
        ...
        // upload.fields([{name: "photo", maxCount: 1}]),
        this.typesOfProductController.updateTypeOfProduct.bind(this.typesOfProductController));
