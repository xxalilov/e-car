...
class InstructionRouter {
    ...
    initializeRoutes() {
        ...
        this.router.get(`${this.path}/:id`, (0, auth_middleware_1.default)("all"), language_middleware_1.default, this.instructionController.getInstructionById.bind(this.instructionController));
