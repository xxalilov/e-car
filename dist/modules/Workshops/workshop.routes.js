...
class WorkshopRouter {
    ...
    initializeRoutes() {
        ...
        this.router.get(`${this.path}`, (0, auth_middleware_1.default)("all"), this.workshopController.getAllWorkshops.bind(this.workshopController));
        this.router.get(`${this.path}/:id`, (0, auth_middleware_1.default)("all"), this.workshopController.getAllWorkshopsByType.bind(this.workshopController));
