...
export type OrderCreationAttributes = Optional<Order, "id" | "userId" | "shipping_type" | "shipping_address" | "shipping_price" | "shipping_status" | "payment_type" | "is_paid" | "total_price">;
