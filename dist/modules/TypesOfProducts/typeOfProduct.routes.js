...
class TypeOfProductRouter {
    ...
    initializeRoutes() {
        ...
        this.router.put(`${this.path}/:id`, (0, auth_middleware_1.default)("admin"), file_1.upload.fields([{ name: "photo", maxCount: 1 }]), this.typesOfProductController.updateTypeOfProduct.bind(this.typesOfProductController));
